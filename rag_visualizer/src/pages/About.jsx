...
import { Globe, Code2, Sparkles, Zap } from 'lucide-react';
import { SiGithub , SiLinkedin , SiHuggingface , SiPatreon ,SiInstagram } from "react-icons/si"
          ...
          >
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
                The comprehensive boilerplate designed to jumpstart your AI
                development. Not just a demo—a production-ready foundation.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
              <div>
                ...
                <p className="text-slate-600 leading-relaxed text-lg">
                  Building RAG applications involves complex plumbing: vector
                  stores, ingestion pipelines, and frontend interfaces.
                  <br />
                  <br />
                  <strong>TUG</strong> solves this by providing a unified,
                  modular starter kit. It includes a powerful visualization
                  layer to help you debug data flows, but the core value lies in
                  the robust codebase.
                </p>
              </div>
              <div className="bg-slate-50 p-8 rounded-3xl border border-slate-200/60 shadow-sm relative overflow-hidden group">
                ...
                <h3 className="font-bold text-slate-900 mb-6 text-lg relative">
                  Tech Stack
                </h3>
                <div className="flex flex-wrap gap-3 relative">
                  {[
                    ...
                    <span
                      key={tech}
                      className="px-3 py-1.5 rounded-lg bg-white border border-slate-200 text-slate-600 text-sm font-medium shadow-sm flex items-center gap-2"
                    >
            ...
            <div className="border-t border-slate-200 pt-20">
              <div>
                <p className="text-2xl md:text-5xl font-bold text-slate-900 mb-6 text-center">
                ...
                <div className="flex flex-col md:flex-row items-center gap-10 relative">
                  <div className="relative group shrink-0">
                    ...
                    <div className="relative">
                      ...
                      />
                      <div
                        className="absolute bottom-2 right-4 bg-white p-1.5 rounded-full border border-slate-100 shadow-lg"
                  ...
                  <div className="text-center md:text-left flex-1">
                    ...
                    <p className="text-slate-600 leading-relaxed mb-8 text-lg">
                      I'm a developer and AI enthusiast who loves building{" "}
                      <span className="text-slate-900 font-semibold underline decoration-indigo-300 decoration-2 underline-offset-2">
                        beautiful, fast, and intelligent
                      </span>{" "}
                      digital experiences. My focus is blending clean UI/UX with
                      powerful tech — turning complex ideas into simple
                      products.
                    </p>
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start gap-4">
                      ...
                      />
                      <SocialLink
                        href="https://linkedin.com/in/utsav-lankapati"
                        icon={SiLinkedin}
                        label="LinkedIn"
                      ...
                      />
                      <SocialLink
                        href="https://huggingface.co/Matrixxboy"
                        icon={SiHuggingface}
                        label="HuggingFace"
                      ...
                      />
                      <SocialLink
                        href="https://patreon.com/Matrixxboy"
                        icon={SiPatreon}
                        label="Support Me"
                        className="hover:text-red-300"
                      />
                      <SocialLink
                        href="https://instagram.com/utsav.lankapati"
                        icon={SiInstagram}
                        label="Instagram"
...
const SocialLink = ({ href, icon: Icon, className, label }) => (
  <a
    href={href}
    target="_blank"
    rel="noopener noreferrer"
    className={`p-3 rounded-xl transition-all duration-200 border border-slate-200/50 text-slate-500 shadow-sm bg-white hover:shadow-md hover:scale-110 ${className}`}
    aria-label={label}
    title={label}
  >
    <Icon size={22} />

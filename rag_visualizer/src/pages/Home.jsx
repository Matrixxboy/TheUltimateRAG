...
const Home = () => {
    ...
    const command = "pip install theultimaterag";
        ...
        <section className="min-h-[90vh] flex flex-col items-center justify-center relative px-6 text-center">
          ...
          >
            ...
            >
              <img
                src="/mainLOGO.png"
                alt=""
                className="md:w-48 md:h-48 w-28 h-28"
              />
            </motion.div>
            <motion.h1
            ...
            >
              Stop building integration glue. Start shipping features. <br />A
              modular, pre-configured foundation for scalable AI applications.
            </motion.p>
            ...
            >
              <NavLink
                to="/demo"
                className="w-full md:w-auto bg-slate-900 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-slate-800 transition-all shadow-xl hover:shadow-2xl hover:scale-105 flex items-center justify-center gap-2 md:hidden lg:hidden"
              >
                View Live Demo
              ...
              <div className="w-full md:w-auto group relative">
                ...
                <div
                  ...
                  className="relative flex items-center bg-white border border-slate-200 rounded-full px-6 py-4 font-mono text-slate-600 text-sm shadow-sm md:min-w-[400px] cursor-pointer"
                >
                  <SiPypi className="w-6 h-6 text-black mr-3" />
                <div className='m-auto'>
                  <span className="text-center mr-auto truncate select-all">{command}</span>
                </div>
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden -z-10">
            <motion.div
              ...
              className="absolute top-20 left-10 w-[500px] h-[500px] bg-purple-200/40 rounded-full mix-blend-multiply filter blur-[100px]"
            />
            <motion.div
              style={{ x: moveBackgroundXReverse, y: moveBackgroundYReverse }}
              className="absolute top-40 right-10 w-[500px] h-[500px] bg-blue-200/40 rounded-full mix-blend-multiply filter blur-[100px]"
            />
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-20 text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-slate-600">
                ...
                have to. From vector database hosting to efficient context
                window management.
              </p>
            </div>
            {/* Stats Strip */}
          ...
          <div className="max-w-5xl mx-auto bg-slate-900 rounded-[3rem] p-12 md:p-20 relative overflow-hidden text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-slate-400 mb-12 max-w-2xl mx-auto">
                ...
                intelligent applications with TUG.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <NavLink
                  to="/demo"
                  className="w-full sm:w-auto bg-white text-slate-900 px-8 py-4 rounded-full font-bold text-lg hover:bg-slate-100 transition-colors"
                >
                  Try Interactive Demo
                </NavLink>
                <NavLink
                  to="/docs"
                  className="w-full sm:w-auto px-8 py-4 rounded-full font-medium text-lg text-white border border-white/20 hover:bg-white/10 transition-colors"
                >
                  Read Documentation
                </NavLink>
              </div>

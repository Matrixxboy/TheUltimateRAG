    ...
    return (
        <div className="space-y-6">
            <div className="glass-panel p-6 rounded-2xl border-l-4 border-l-indigo-500">
                <h3 className="text-lg font-bold mb-4 text-slate-800">Relevance Scores</h3>
                <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={relevanceData.length > 0 ? relevanceData : relevanceDataMock}>
            ...
            <div className="glass-panel p-6 rounded-2xl border-l-4 border-l-emerald-500">
                <h3 className="text-lg font-bold mb-4 text-slate-800">Knowledge Composition</h3>
                <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                            <Pie
                            ...
                            <Tooltip contentStyle={{ backgroundColor: '#ffffff', borderColor: '#e2e8f0', color: '#1e293b', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }} />
